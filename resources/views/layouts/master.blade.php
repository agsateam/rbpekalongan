...
<body class="font-manrope">
    ...
    <div class="w-full bg-[#195770]">
        <div class="flex flex-col md:flex-row max-w-screen-xl mx-8 md:mx-14 2xl:mx-auto py-16">
            <div class="flex flex-col items-start">
                <div class="flex flex-col md:flex-row md:justify-center md:items-center">
                    ...
                    <div class="ml-2 mt-3 md:ml-0 md:mt-0 font-bold text-md text-xl md:text-5xl text-white">Pekalongan
                    </div>
                </div>
            ...
            @php
                ...
                $data = LinkMedsos::select(['shoppe', 'tokopedia', 'tiktok', 'instagram'])->first();
            @endphp
        ...
        <div class="w-full h-14 bg-contain" style="background-image: url('{{ url('/') }}/images/batik1.png')">
        </div>
    </div>
