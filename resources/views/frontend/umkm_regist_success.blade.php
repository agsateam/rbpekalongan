...
@section('title', 'Regist Success')
@section('content')

<div class="py-16">
    <div class="max-w-screen-xl mx-8 md:mx-14 2xl:mx-auto">
        <div class="flex flex-row justify-between items-center">
            <h4 class="text-3xl md:text-4xl font-bold mb-5">UMKM</h4>
        ...
        <div class="bg-white border rounded-md p-10">
            <div class="flex flex-col items-center">
                ...
                <span class="text-2xl md:text-4xl font-bold mt-3">Pendaftaran Berhasil</span> 
                <p class="mt-3 text-xl text-center max-w-lg">Pendaftaran UMKM berhasil, kami akan menghubungi anda untuk info lebih lanjut.</p>
            </div>
        </div>
    </div>
</div>
