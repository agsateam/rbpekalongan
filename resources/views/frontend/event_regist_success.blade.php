    ...
    <div class="max-w-screen-xl mx-8 md:mx-14 2xl:mx-auto">
        ...
        <div class="bg-white border rounded-md p-10">
            <div class="flex flex-col items-center">
                ...
                <span class="text-2xl md:text-4xl font-bold mt-3">Registrasi Berhasil</span> 
                <p class="mt-3 text-xl text-center max-w-lg">Registrasi anda untuk event ini berhasil, kami akan melakukan verifikasi data anda.</p>
            </div>
        </div>
    </div>
</div>
