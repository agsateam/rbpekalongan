...
<div class="md:px-5">
    <div class="flex flex-col md:flex-row justify-between">
        <h4 class="text-2xl md:text-3xl font-bold mb-5">Tambah Ruang</h4>
    ...
    <div class="flex flex-col border rounded-md p-5 mt-2">
        <form class="grid grid-cols-1 md:grid-cols-2 gap-2" action="{{route('manage.room.save')}}" method="post">
            @csrf
