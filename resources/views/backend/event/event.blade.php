    ...
    $(document).ready(function() {
        $('#event-table').DataTable({
            ...
            drawCallback: function () {
                ...
                $('a.paginate_button.previous').addClass('mr-2');
                $('a.paginate_button.next').addClass('ml-2');
                $('a.paginate_button.current').addClass('mx-1 bg-[#195770] text-white hover:text-gray-600');
