        ...
        <form class="p-4 md:p-5" action="{{ route('webcontent.fungsiupdate', $fungsirb->id) }}" method="POST"
            ...
            <div class="flex flex-wrap items-center justify-center w-full mb-4 gap-4">
                ...
                <label for="dropzone-file1"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 {{ $fungsirb->foto1 ? 'hidden' : '' }}"
                        ...
                        <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click</span>
                        </p>
                        <p class="text-xs text-gray-500 dark:text-gray-400">PNG or JPG</p>
                    </div>
                    <img id="image-preview1" src="{{ $fungsirb->foto1 }}" alt="Preview"
                        class="{{ $fungsirb->foto1 ? '' : 'hidden' }} w-full h-full object-cover rounded-lg" />
                ...
                <label for="dropzone-file2"
                    class="flex flex-col items-center justify-center w-40 h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-gray-100 ">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 {{ $fungsirb->foto2 ? 'hidden' : '' }}"
                    ...
                    <img id="image-preview2" src="{{ $fungsirb->foto2 }}" alt="Preview"
                        class="{{ $fungsirb->foto2 ? '' : 'hidden' }} w-full h-full object-cover rounded-lg" />
                ...
                <label for="dropzone-file3"
                    class="flex flex-col items-center justify-center w-40 h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-gray-100 ">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 {{ $fungsirb->foto3 ? 'hidden' : '' }}"
                    ...
                    <img id="image-preview3" src="{{ $fungsirb->foto3 }}" alt="Preview"
                        class="{{ $fungsirb->foto3 ? '' : 'hidden' }} w-full h-full object-cover rounded-lg" />
                ...
                <label for="dropzone-file4"
                    class="flex flex-col items-center justify-center w-40 h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-gray-100 ">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 {{ $fungsirb->foto4 ? 'hidden' : '' }}"
                    ...
                    <img id="image-preview4" src="{{ $fungsirb->foto4 }}" alt="Preview"
                        class="{{ $fungsirb->foto4 ? '' : 'hidden' }} w-full h-full object-cover rounded-lg" />
                ...
                <label for="dropzone-file5"
                    class="flex flex-col items-center justify-center w-40 h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-gray-100 ">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 {{ $fungsirb->foto5 ? 'hidden' : '' }}"
                    ...
                    <img id="image-preview5" src="{{ $fungsirb->foto5 }}" alt="Preview"
                        class="{{ $fungsirb->foto5 ? '' : 'hidden' }} w-full h-full object-cover rounded-lg" />
            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
                <div class="col-span-2">
                    ...
                    <textarea id="modal-deskripsi" rows="4"
                        ...
                        placeholder="Masukkan deskripsi fungsi" name="deskripsi">{{ $fungsirb->deskripsi }}</textarea>
                </div>
            </div>
