...
@section('content')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div class="">
            ...
            <form class="p-4 md:p-5" action="{{ route('webcontent.mitra.update') . '/' . $mitra->id }}" method="POST"
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="mb-5">
                        ...
                        <input type="text" id="nama_mitra"
                            ...
                            name="nama_mitra" value="{{ old('nama_mitra', $mitra->nama_mitra) }}" required />
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="link"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                            value="{{ old('link', $mitra->link) }}" name="link" required />
                    </div>
                </div>
